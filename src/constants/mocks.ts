...
export const MOCK_WRITING1: WritingServerModel = {
  id: 1,
  author_id: 1,
...
export const MOCK_WRITING2: WritingServerModel = {
  id: 2,
  author_id: 1,
...
export const MOCK_WRITING3: WritingServerModel = {
  id: 3,
  author_id: 1,
...
export const MOCK_WRITING4: WritingServerModel = {
  id: 4,
  author_id: 1,
  title: 'Νόμοι',
  title_in_kor: 'Laws',
...
export const MOCK_WRITING5: WritingServerModel = {
  id: 5,
  author_id: 1,
